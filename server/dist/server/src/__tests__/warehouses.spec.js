...
async function main() {
    ...
    try {
        ...
        const createWithoutAddressBody = createWithoutAddress.json();
        ...
        const updateWithoutAddressBody = updateWithoutAddress.json();
        ...
        const getWithoutAddressBody = getWithoutAddress.json();
        ...
        const afterDeleteBody = afterDeleteWarehouse.json();
