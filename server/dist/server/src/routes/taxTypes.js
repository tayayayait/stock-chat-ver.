import { createTaxType, ensureTaxTypeSeedData, listTaxTypes, } from '../stores/taxTypesStore.js';
const isTaxMode = (value) => value === 'exclusive' || value === 'inclusive';
...
function validateTaxTypePayload(body) {
...
export default async function taxTypesRoutes(server) {
