...
import {
  ...
  peekNextSalesOrderNumberForContext,
  resolveOrderDateContext,
  type SalesOrderDraftPayload,
} from '../stores/salesOrdersStore.js';
import type { CreateSalesOrderInput } from '../stores/salesOrdersStore.js';
...
const resolveTenantId = (request: FastifyRequest): string => {
...
const normalizeSalesOrderLines = (lines?: CreateSalesOrderBody['lines']) => {
...
const buildSalesOrderPayload = (body: CreateSalesOrderBody, tenantId: string): CreateSalesOrderInput => ({
...
const buildSalesOrderDraftPayload = (body: CreateSalesOrderBody, tenantId: string): SalesOrderDraftPayload => ({
