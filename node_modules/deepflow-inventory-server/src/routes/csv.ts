...
const warehouseCatalog: Record<string, { name: string }> = {
...
function buildStockKey(sku: string, warehouse: string): string {
...
type WarehouseParseResult =
  | { success: true; value: { warehouseCode: string } }
  | { success: false; errors: string[] };

function parseWarehouseField(raw: string | undefined): WarehouseParseResult {
  if (!raw || !raw.trim()) {
